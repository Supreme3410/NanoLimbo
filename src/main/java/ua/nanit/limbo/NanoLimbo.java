...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "8675836b-69d6-4048-92fb-bd19034891fe"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_PORT", "30290");      // argo隧道端口，使用固定隧道token需要在cloudflare里设置和这里一致
        ...
        envVars.put("HY2_PORT", "30290");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
